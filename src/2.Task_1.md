...
De eerste taak is het verwerken van een order in het magazijn.
```plantuml
@startuml
[*] --> Nieuwe_order
...
Voorraad_controle --> Backorder : Niet op voorraad (administratief)
...
Order_controle --> Backorder : Niet op voorraad (werkelijke voorraad)
